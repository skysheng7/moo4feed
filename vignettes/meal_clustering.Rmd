...
```{r fixed-interval-demo, fig.width=5, fig.height=3}
...
```{r fixed-interval-clustering-reshow, fig.width=5, fig.height=3}
...
```{r compare-clustering, fig.width=5, fig.height=3}
...
```{r individual-plots, fig.width=5, fig.height=3}
...
```{r date-plots, fig.width=5, fig.height=3}
