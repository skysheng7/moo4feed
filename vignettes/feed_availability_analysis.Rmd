...
Understanding when feed is added to bins and how much feed is available when animals visit helps researchers and farm managers:

- **Monitor feed management**: Identify when bins are refilled throughout the day
- **Assess feed competition**: Animals visiting when bins are nearly empty may be disadvantaged
- **Optimize feeding schedules**: Understand the relationship between feed delivery timing and animal visits
