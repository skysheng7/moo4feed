...
df <- data.frame(
  Start_time = c("01:30:00", "02:30:00", "04:00:00"),
...
test_that("edge case: when user provided dataframe about daylight saving change days does not include the year when data was recorded.", {
  expect_error(
    ...
    "you provided does not contain daylight saving time information for the year",
    fixed = TRUE
  )
})
...
df <- data.frame(
  Start_time = c("00:02:02", "01:30:00", "02:30:00", "04:00:00", "23:00:00", "23:05:00"),
  End_time = c("00:17:00", "02:00:00", "02:35:00", "04:30:00", "23:01:00", "23:08:00")
)
expect <- data.frame(
  Start_time = c("00:02:02", "03:30:00", "05:00:00"),
...
df <- data.frame(
  Start_time = c("23:00:01", "23:05:01", "01:30:00", "02:30:00", "04:00:00"),
...
df <- data.frame(
  Start_time = c("00:02:02", "01:30:00", "02:30:00", "04:00:00"),
  End_time = c("00:17:00", "02:00:00", "02:35:00", "04:30:00")
)
expect <- data.frame(
  Start_time = c("00:02:02", "03:00:00"),
...
df_bad_time <- data.frame(
  start = c("01:30:00", "not_a_time", "04:00:00"),
  end = c("02:00:00", "03:00:00", "04:30:00")
)
...
df <- data.frame(
  Start = c("00:02:02", "01:30:00", "02:30:00", "04:00:00"),
